                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-300 text-sm md:text-base leading-relaxed">
                            Tu plataforma deportiva para seguir a tus equipos y deportistas favoritos. Compra entradas y vive la emoción del deporte.
                        </p>
                    ...
                    {/* Enlaces rápidos */}
                    <div className="space-y-4">
                        <h3 className="text-lg md:text-xl font-semibold text-white">Enlaces Rápidos</h3>
                    ...
                    {/* Información */}
                    <div className="space-y-4">
                        <h3 className="text-lg md:text-xl font-semibold text-white">Información</h3>
                        <ul className="space-y-2">
                            <li>
                ...
                <div className="px-4 sm:px-8 md:px-20 lg:px-40 py-6">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                        <p className="text-gray-400 text-sm text-center sm:text-left">
                            © {currentYear} Sportify. Todos los derechos reservados.
                        </p>
